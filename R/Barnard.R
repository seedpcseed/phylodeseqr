#' @name Barnard
#' @title Barnard for proportional testing
#' @param data A 2x2 matrix
#' @param Tbx Number of matricies to test
#' @param to.plot TRUE or FALSE to plot 
#' @param to.print TRUE or FALSe to print the text output
#' @examples
#' Barnard(data=dm, Tbx=200, to.plot=TRUE, to.print=TRUE)
Barnard<-function (data, Tbx = 100, to.plot = TRUE, to.print = TRUE) 
{
